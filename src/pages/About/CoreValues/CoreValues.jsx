...
const CoreValues = () => {
  return (
    <div className="bg-[#021E4C] text-white py-5">
      ...
      <div className="px-4 md:px-8 lg:pl-20 lg:pr-16 md:mx-28 backdrop:sm:max-w-xl md:max-w-full lg:max-w-screen-xl py-10 lg:py-20 bg-[#082C6B] text-white shadow-2xl rounded-2xl">
