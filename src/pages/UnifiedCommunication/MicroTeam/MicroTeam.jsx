...
const MicroTeam = () => {
  return (
    <div className="bg-[#07121C] p-5">
      <div className="flex flex-col-reverse md:flex-row justify-around text-justify py-10 px-4 md:px-8 lg:px-20 bg-[#091424] text-white shadow-2xl rounded-2xl">
