import img3 from "../../../assets/web-development/image3.png";
      ...
      <div className="relative bg-[#072966] z-30 mx-4 md:mx-8 lg:mx-20 rounded-2xl">
        <div className="flex flex-col md:flex-row justify-between items-center h-full">
          ...
          <div className="w-full md:w-1/3 text-white text-left mx-4 md:mx-8">
            ...
            <br />
            <br />
            <a className="btn bg-[#BD981B] hover:bg-blue-950 hover:text-white w-full md:w-[195px] mr-0 md:mr-4 mb-2 md:mb-0 font-inter text-25 font-medium">
